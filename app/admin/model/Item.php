...
class Item extends Model
{
    ...
    public function add()
    {
        $data = [
            ...
            'buy' => unescapePic(Request::post('buy', '', null)),
            'procedure' => unescapePic(Request::post('procedure', '', null)),
            'introduce' => unescapePic(Request::post('introduce', '', null)),
            'service' => unescapePic(Request::post('service', '', null)),
            ...
            'column_content1' => unescapePic(Request::post('column_content1', '', null)),
            'column_name2' => Request::post('column_name2'),
            'column_content2' => unescapePic(Request::post('column_content2', '', null)),
            'column_name3' => Request::post('column_name3'),
            'column_content3' => unescapePic(Request::post('column_content3', '', null)),
            'column_name4' => Request::post('column_name4'),
            'column_content4' => unescapePic(Request::post('column_content4', '', null)),
            'column_name5' => Request::post('column_name5'),
            'column_content5' => unescapePic(Request::post('column_content5', '', null)),
