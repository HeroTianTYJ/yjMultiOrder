...
class Item extends Model
{
    ...
    public function add()
    {
        $data = [
            ...
            'copyright' => Request::post('copyright', '', 'htmlspecialchars_decode'),
            'code_type' => Request::post('code_type'),
            'code' => Request::post('code', '', 'htmlspecialchars_decode'),
            'tel' => Request::post('tel'),
            'sms' => Request::post('sms'),
            'qq' => Request::post('qq'),
            'picture' => Request::post('picture'),
            'buy' => unescapePic(Request::post('buy', '', 'htmlspecialchars_decode')),
            'procedure' => unescapePic(Request::post('procedure', '', 'htmlspecialchars_decode')),
            'introduce' => unescapePic(Request::post('introduce', '', 'htmlspecialchars_decode')),
            'service' => unescapePic(Request::post('service', '', 'htmlspecialchars_decode')),
            ...
            'column_content1' => unescapePic(Request::post('column_content1', '', 'htmlspecialchars_decode')),
            'column_name2' => Request::post('column_name2'),
            'column_content2' => unescapePic(Request::post('column_content2', '', 'htmlspecialchars_decode')),
            'column_name3' => Request::post('column_name3'),
            'column_content3' => unescapePic(Request::post('column_content3', '', 'htmlspecialchars_decode')),
            'column_name4' => Request::post('column_name4'),
            'column_content4' => unescapePic(Request::post('column_content4', '', 'htmlspecialchars_decode')),
            'column_name5' => Request::post('column_name5'),
            'column_content5' => unescapePic(Request::post('column_content5', '', 'htmlspecialchars_decode')),
            'template_id' => Request::post('template_id'),
            'product_type' => Request::post('product_type'),
            'product_view_type' => Request::post('product_view_type'),
            'sort' => implode(',', Request::post('sort')),
            'nav' => trim(Request::post('nav', '', 'htmlspecialchars_decode')),
