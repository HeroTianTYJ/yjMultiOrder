...
class OrderStatistic extends Base
{
    public function index()
    {
        ...
        $Order = new Order();
        View::assign(['Total' => 9, 'Search' => Html::orderSearch($Order->search, $Order->isCommission)]);
        return $this->view();
    }
    ...
    private function dayMonthYear($time)
    {
        ...
        $Order = new Order();
        View::assign([
            'Total' => $orderDayMonthYearTotal,
            'Param' => $param,
            'Search' => Html::orderSearch($Order->search, $Order->isCommission)
        ]);
        return $this->view();
    }
}
